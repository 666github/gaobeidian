...
function AlertView(_config){
	...
	this.hide=function(){
		nodeFrame.hide();
		if(typeof config.callback ==="function"){config.callback.call(content,"hide");}
		return this;
	};
	this.remove=function(){
	...
	nodeClose.bind("click",function(){
		if(typeof config.callback ==="function"){config.callback.call(content,"close");}
		content.remove();
	});
...
window.Request=function(_url){
	if(this!=window){throw "Request：请使用无new构造创建此对象！如： var s=Request({})";}
